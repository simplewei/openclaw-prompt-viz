...
5. **Environment Scan** (optional but recommended): Run a quick scan of available CLI tools and cache to `/.tools_cache.txt` for faster tool selection (see TOOLS.md)
